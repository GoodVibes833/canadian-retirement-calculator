...
- later return-of-capital and capital-loss carryforward treatment.
...
- non-registered withdrawals now track adjusted cost base and realize taxable capital gains using the ruleset inclusion rate, while explicit taxable-account interest and Canadian eligible / non-eligible dividends can be modeled as annual cash income; the engine still warns heavily when ACB is missing and does not yet model return of capital, foreign dividend character, or capital-loss carryforwards,
...
2. Add return-of-capital handling plus dividend / capital-loss ledger depth for taxable accounts.
