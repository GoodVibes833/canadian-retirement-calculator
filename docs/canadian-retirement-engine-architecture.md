...
3. Deepen GIS / Allowance with exact prior-year reassessment timing, quarterly SG3-3 table behavior, and more detailed widowhood / low-income edge cases.
4. Add fuller survivor modeling including richer CRA final-return and optional-return handling, Quebec will-form probate detail, broader joint-ownership and beneficial-ownership analysis, and more exact CPP / QPP combined-benefit behavior below age 65 and at form-level detail.
