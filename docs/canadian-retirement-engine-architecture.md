...
1. Deepen GIS / Allowance and OAS with exact prior-year reassessment timing plus quarterly SG3-3 table behavior.
2. Add widowhood year+1 OAS / GIS / Allowance reassessment behavior on top of the current survivor baseline.
