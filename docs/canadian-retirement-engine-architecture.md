...
4. Add fuller survivor modeling including actual death-year tax handling, probate effects, and more exact CPP / QPP combined-benefit behavior below age 65 and at form-level detail.
