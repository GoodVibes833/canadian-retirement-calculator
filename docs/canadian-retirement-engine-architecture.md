...
- GIS / Allowance now use a baseline current-year income proxy with the published 2026 maximums and income cutoffs, plus the work-income exemption, but exact prior-year Service Canada reassessment timing and quarterly SG3-3 table detail remain incomplete,
