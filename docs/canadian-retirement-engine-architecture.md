...
1. Deepen survivor modeling with richer CRA final-return and optional-return handling plus more exact CPP / QPP combined-benefit behavior below age 65.
2. Deepen GIS / Allowance and OAS with exact prior-year reassessment timing plus quarterly SG3-3 table behavior.
...
5. Tighten Quebec estate settlement with will-search, court/notary fee detail, and broader beneficial-ownership analysis.
6. Add Monte Carlo.
